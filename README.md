...
The Support group can be reached out to at [support](https://t.me/futabariosupport), where you can ask for help about [Mihai SUPPORT '](https://t.me/mihaiflorecubot), discover/request new features, report bugs, and stay in the loop whenever a new update is available. 
